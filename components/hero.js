...
import heroImg from "../public/img/savingEnergy.png";
        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Center for Net Zero Emission Knowledge and Skill
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
            Founded in 2017, ECADIN is a research, learning center and knowledge hub on current research directions, 
            industrial developments and regulations in(out)side Indonesia in the energy sectors & sustainability concerns.
            We work closely with national and multinational stakeholders to embrace a transformational approach aimed at unlocking 
            potentials to grow towards a sustainable future.
            </p>
            ...
            <div className="flex flex-col items-start space-x-3 space-y-3 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="px-8 py-4 text-lg font-medium text-center text-white bg-[#4ABE39] rounded-md ">
                Login
              </a>
              <a
                href="https://github.com/web3templates"
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Trusted by <span className="text-[#4ABE39]">2000+</span> customers 
          </div>
